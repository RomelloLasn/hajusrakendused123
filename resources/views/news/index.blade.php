        ...
        @forelse ($news as $item)
            <div class="col">
                <div class="card news-card h-100">
                    ...
                    @if($item->image)
                        <img src="{{ $item->image }}" class="card-img-top news-image" alt="{{ $item->title }}" style="height: 160px; object-fit: cover; border-top-left-radius: 12px; border-top-right-radius: 12px;">
                    @else
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-1">
                            <h6 class="published-title">Published At</h6>
